            ...
            <div class="card mb-4">
                <div class="card-body card-main-three">
                    ...
                    <form class="form-floating" action="{{route('achievement_update',['id'=>$achievement_list->id])}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            <span class="form-floating">
                                <input type="file" class="form-control" id="TextInput" placeholder="image" value="{{$achievement_list->image}}" name="image" >
                                <label class="" for="TextInput">Image</label>
                                <img src="{{$achievement_list->image}}" alt="" width='100px'>
                            </span>
                        </div>
                        <div class="mb-4">
