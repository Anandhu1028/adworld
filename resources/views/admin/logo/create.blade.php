        ...
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-body card-main-three">
                    ...
                    <form class="form-floating" action="{{route('logo_store_data')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            <span class="form-floating">
                                <input type="file" class="form-control" id="TextInput" placeholder="image" name="image" required>
