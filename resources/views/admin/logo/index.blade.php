                        ...
                        <table class="table mb-0 align-middle myDataTable table-hover" style="width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('logo_show',['id'=>$logo->id])}}" class="btn btn-warning">Open</a>
                                        <a href="{{route('logo_all_delete',['id'=>$logo->id])}}" onclick="return confirm('Are you sure you want to delete this item?')" class="btn btn-danger">Delete</a>
                                    </td>
                                </tr>
                            @endforeach
                                <tr>
                                    <form action="{{route('logo_store')}}" method="POST">
                                        @csrf
                                        <td></td>
                                        <td><div class="w-50">
                                            <span class="">
